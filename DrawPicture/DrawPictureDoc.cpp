...
// DrawPictureDoc.cpp: CDrawPictureDoc 类的实现
//
...
// CDrawPictureDoc 构造/析构

CDrawPictureDoc::CDrawPictureDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CDrawPictureDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CDrawPictureDoc::InitializeSearchContent()
{
...
void CDrawPictureDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
